                ...
                success:function (data){
                    ...
                    $.each(data.list,function (i,item){
                        html+='<li class="clearfix"> <div class="text_con l"> ' +
                            '<a href="/read/92" target="_blank"> <p class="title">'+item.title+'</p> </a> ' +
...
<div id="new_header" class="special-header">
    <div class="page-container new-header clearfix" id="nav" style="width:1152px;">
        <ul class="nav-item">
            <li><a href="/main" target="_self" class="imooc">首页</a></li>
        ...
        <div class="waper">
            <div class="footerwaper clearfix">
                <div class="footer_intro l">
                    ...
                    <p>Copyright <img draggable="false" class="moco-emoji" alt="©" src="https://www.imooc.com/static/moco/v1.0/images/face/36x36/a9.png"> 2021 imooc.com All Rights Reserved | <a rel="nofollow" href="https://beian.miit.gov.cn/" style="color: #93999F;" target="_blank">京ICP备 12003892号-11</a> <a rel="nofollow" href="http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=11010802030151" style="color: #93999F;margin:0 5px;" target="_blank"><i class="beian"></i>京公网安备11010802030151号</a></p>
                </div>
            </div>
        </div>
    </div>
